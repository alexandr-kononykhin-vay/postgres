...
// BitMaskAndNeq field name bit mask & to value
type BitMaskAndNeq struct {
	Column   string
	Value    interface{}
	Expected interface{}
}

// BitMaskOrNeq field name bit mask | to value
type BitMaskOrNeq struct {
	Column   string
	Value    interface{}
	Expected interface{}
}

// BitMaskAndEq field name bit mask & to value
type BitMaskAndEq struct {
	Column   string
	Value    interface{}
	Expected interface{}
}

// BitMaskOrEq field name bit mask | to value
type BitMaskOrEq struct {
	Column   string
	Value    interface{}
	Expected interface{}
}
...
// PostGISIntersectionWithCircle is the filter to validate the PostGIS geometry object intersection with the circle
// at the point of Longitude, Latitude, and the given Radius in meters.
type PostGISIntersectionWithCircle struct {
	Column       string
	Longitude    float64
	Latitude     float64
...
// Condition provide query condition
func (c BitMaskAndNeq) Condition() string {
	return "? & ? != ?"
}

// Params provide query params
func (c BitMaskAndNeq) Params() []interface{} {
	return []interface{}{
		pg.Ident(c.Column),
		c.Value,
		c.Expected,
...
// Condition provide query condition
func (c BitMaskOrNeq) Condition() string {
	return "? | ? != ?"
}

// Params provide query params
func (c BitMaskOrNeq) Params() []interface{} {
	return []interface{}{
		pg.Ident(c.Column),
		c.Value,
		c.Expected,
...
// Condition provide query condition
func (c BitMaskAndEq) Condition() string {
	return "? & ? = ?"
}

// Params provide query params
func (c BitMaskAndEq) Params() []interface{} {
	return []interface{}{
		pg.Ident(c.Column),
		c.Value,
		c.Expected,
...
// Condition provide query condition
func (c BitMaskOrEq) Condition() string {
	return "? | ? = ?"
}

// Params provide query params
func (c BitMaskOrEq) Params() []interface{} {
	return []interface{}{
		pg.Ident(c.Column),
		c.Value,
		c.Expected,
...
// Condition provide query condition
func (c PostGISIntersectionWithCircle) Condition() string {
	// Filter  INTERSECTS g, with      CIRCLE around POINT at (lon,lat) and  radius
	return "ST_INTERSECTS(?, ST_Buffer(ST_SetSRID(ST_MakePoint(?, ?), 4326), ?))"
}

// Params provide query params
func (c PostGISIntersectionWithCircle) Params() []interface{} {
	return []interface{}{
		pg.Ident(c.Column),
		c.Longitude,
		c.Latitude,
